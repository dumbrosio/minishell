...
SRC_FILES	:= minishell parser parser_utils path utils1 utils2 debug executor executor_utils1 executor_utils2 expander executor_utils3 env1 env2 builtins1 builtins2 builtins3 builtins4 heredoc path2
SRC_DIR		:= ./src/
