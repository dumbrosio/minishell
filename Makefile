...
SRC_FILES	:= minishell parser parser_utils path utils debug executor executor_utils1 executor_utils2  executor_utils3 env1 env2 builtins1 builtins2 builtins3
SRC_DIR		:= ./src/
