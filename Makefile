...
SRC_FILES	:= minishell parser parser_utils path utils debug executor executor_utils1 executor_utils2 expander executor_utils3 env1 env2 builtins1 builtins2 builtins3 heredoc
SRC_DIR		:= ./src/
