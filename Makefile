...
SRC_FILES	:= minishell parser parser_utils path1 path2 utils1 utils2 executor executor_utils1 executor_utils2 expander executor_utils3 env1 builtins1 builtins2 builtins3 builtins4 builtins5 heredoc
SRC_DIR		:= ./src/
